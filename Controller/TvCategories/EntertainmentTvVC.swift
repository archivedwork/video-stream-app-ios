...
class EntertainmentTvVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        DispatchQueue.global(qos: .background).async {
            ...
            // get image link
            let imageUrl: NSURL? = NSURL(string: api.channels_image!)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        Alamofire.request(ENTERTAINMENT_URL).responseJSON { response in
